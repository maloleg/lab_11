...
static const char qt_meta_stringdata_Figure[] = {
    ...
    "FigureClicked()\0Rotation()\0RotationDir()\0"
};
...
void Figure::qt_static_metacall(QObject *_o, QMetaObject::Call _c, int _id, void **_a)
{
    if (_c == QMetaObject::InvokeMetaMethod) {
        ...
        case 3: _t->Rotation(); break;
        case 4: _t->RotationDir(); break;
        default: ;
        }
    }
    Q_UNUSED(_a);
...
const QMetaObjectExtraData Figure::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject Figure::staticMetaObject = {
    { &QWidget::staticMetaObject, qt_meta_stringdata_Figure,
      qt_meta_data_Figure, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &Figure::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_Figure))
